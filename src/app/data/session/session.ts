...
export class Session extends EventTarget {
  ...
  private configureWebSocket(config: SoulMachinesConfig) {
    ...
    this.addEventListener = (type, listener) => this.ws.addEventListener(type, listener);
    this.removeEventListener = (type, listener) => this.ws.removeEventListener(type, listener);
