...
describe('<LoadingIndicator />', () => {
  it('has the aria-busy value of true', () => {
    const { getByRole } = render(<LoadingIndicator progress={ProgressStage.idle} />);
    expect(getByRole('progressbar')).toHaveAttribute('aria-busy', 'true');
  });

  describe('when it is in step 1', () => {
    it('has the aria-busy value of true', () => {
      const { getByRole } = render(<LoadingIndicator progress={ProgressStage.step1} />);
      expect(getByRole('progressbar')).toHaveAttribute('aria-busy', 'true');
    });
  ...
  describe('when it is in step 2', () => {
    it('has the aria-busy value of true', () => {
      const { getByRole } = render(<LoadingIndicator progress={ProgressStage.step2} />);
      expect(getByRole('progressbar')).toHaveAttribute('aria-busy', 'true');
    });
  ...
  describe('when it is in step 3', () => {
    it('has the aria-busy value of true', () => {
      const { getByRole } = render(<LoadingIndicator progress={ProgressStage.step3} />);
      expect(getByRole('progressbar')).toHaveAttribute('aria-busy', 'true');
    });
  ...
  describe('when it is completed', () => {
    it('has the aria-busy value of false', () => {
      const { getByRole } = render(<LoadingIndicator progress={ProgressStage.completed} />);
