...
export function LoadingIndicator({
  ...
  return (
    ...
    >
      ...
      <div className="sm-bg-white sm-rounded-3xl sm-border-gray-base sm-border sm-border-solid sm-overflow-hidden sm-w-2/5 sm-h-3 sm-absolute sm-top-1/2 sm-left-1/2 -sm-translate-x-1/2 -sm-translate-y-1/2">
