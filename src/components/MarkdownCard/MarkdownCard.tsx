  ...
  return (
    <Card style={style}>
      <div
        ...
        className="sm-sans sm-flex sm-flex-col sm-gap-y-3 sm-items-start sm-h-full sm-max-h-contentCard sm-overflow-y-auto sm-text-black sm-font-normal sm-font-primary"
      >
        {/*
