import { a3 as e } from './iframe.1f3a3e8b.js';
import { k as i, G as s } from './index.ef5de913.js';
var t;
function l(r, o) {
  return (
    o || (o = r.slice(0)),
...
var n = i(t || (t = l(['0%{z-index:0}to{z-index:-1}']))),
  a = function (o) {
    return {
      ...
      '.os-resize-observer': { animationDuration: '.001s', animationName: ''.concat(n) },
...
//# sourceMappingURL=GlobalScrollAreaStyles-8793ce4a.43bf8515.js.map
